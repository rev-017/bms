                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                    ...
                                    <input value="'.$row['actionTaken'].'"  class="form-control input-sm" name="ddl_edit_acttaken" disabled/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                    ...
                                    <input value="'.$row['sStatus'].'"  class="form-control input-sm"  name="ddl_edit_stat" disabled/>
