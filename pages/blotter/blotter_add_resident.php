              ...
              <div class="modal-dialog modal-lg" >
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">File Complaint</h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="txt_cname" class="form-control input-sm select2" style="width:100%">
                                            ...
                                            <?php
                                                $qc = mysqli_query($con,"SELECT * from resident");
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="txt_pname" class="form-control input-sm select2" style="width:100%">
                                            ...
                                            <?php
                                                $qp = mysqli_query($con,"SELECT * from resident");
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                         <input value = "For Review" name="ddl_acttaken"  class="form-control input-sm" readonly= "readonly"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                         <input value = "For Review" name="ddl_stat""  class="form-control input-sm" readonly= "readonly"/>
                                    </div>
